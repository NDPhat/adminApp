...
class MyScrollDatePicker extends StatefulWidget {
  MyScrollDatePicker({
    Key? key,
    ...
    this.indicator, required this.widthScreen,
  ...
  @override
  State<MyScrollDatePicker> createState() => _MyScrollDatePickerState();
}

class _MyScrollDatePickerState extends State<MyScrollDatePicker> {
  ...
  @override
  void didUpdateWidget(covariant MyScrollDatePicker oldWidget) {
